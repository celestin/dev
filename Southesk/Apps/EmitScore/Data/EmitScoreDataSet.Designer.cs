...
namespace Southesk.Apps.EmitScore.Data {
    ...
    public partial class EmitScoreDataSet : global::System.Data.DataSet {
        ...
        public partial class LocationDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public LocationRow AddLocationRow(int LocationId, string LocationName, int Points) {
        ...
        public partial class GroupDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public GroupRow AddGroupRow(int GroupId, string GroupName, CategoryRow parentCategoryRowByFK_Group_Category) {
...
namespace Southesk.Apps.EmitScore.Data.EmitScoreDataSetTableAdapters {
    ...
    public partial class GroupTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Group] ([GroupId], [GroupName], [CategoryId]) VALUES (@p1, @p2, @p3)" +
                "";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [Group] SET [GroupId] = @p1, [GroupName] = @p2, [CategoryId] = @p3 WHERE (" +
                "([GroupId] = @p4))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@p4", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, true, 0, 0, "GroupId", global::System.Data.DataRowVersion.Original, null));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT [GroupId], [GroupName], [CategoryId] FROM [Group]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
