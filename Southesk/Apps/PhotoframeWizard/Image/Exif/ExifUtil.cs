...
namespace Fb.Apps.PhotoframeWizard.Image.Exif
{
  ...
  /// EXIFextractor Class.
  /// </summary>
  public class ExifUtil : IEnumerable
  {
    /// <summary>
    ...
    private static PropertyItem CreatePropertyItem(short type, int tag, int len, byte[] value)
    {
      ...
      Stream emptyBitmapStream = assembly.GetManifestResourceStream("ExifUtil.decoy.jpg");
    ...
    /// <param name="sp"></param>
    public ExifUtil(ref System.Drawing.Bitmap bmp, string sp)
    {
    ...
    string msp = "";
    public ExifUtil(ref System.Drawing.Bitmap bmp, string sp, string msp)
    {
      properties = new Hashtable();
      this.sp = sp;
      this.msp = msp;
    ...
    public ExifUtil(string file, string sp, string msp)
    {
      properties = new Hashtable();
      this.sp = sp;
      this.msp = msp;
    ...
    public DateTime GetDateTimeProperty(string property)
    {
      if (this[property] == null) return DateTime.Now;

      string dateTimeValue = this[property].ToString();
      string[] elements = dateTimeValue.Split(new char[] { ':', ' ' });
      int year = 0;
      int month = 0;
      int day = 0;
      int hour = 0;
      ...
      {
        int v = Int32.Parse(element.Trim());
        switch (i)
        {
          case 0: year = v; break;
          ...
          case 2: day = v; break;
          case 3: hour = v; break;
          case 4: minute = v; break;
          case 5: second = v; break;
        }
        i++;
      }
    ...
    public DateTime DateTimeTaken
    {
      get
      {
        return GetDateTimeProperty("DTOrig");
      }
    }
