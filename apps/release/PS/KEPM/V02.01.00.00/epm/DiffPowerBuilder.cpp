...
DiffPowerBuilder::DiffPowerBuilder(const char *filename1, const char *filename2) : Diff(filename1, filename2, true)
{
  theNSCValid = false;
}


void DiffPowerBuilder::getLineCR(FILE *input, char *&currline)
{
  try
  {
    char buffer[1000];
...
void DiffPowerBuilder::getLineSC(FILE *input, char *&currline)
{
}
