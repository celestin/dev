...
KRAKATAU PROFESSIONAL (Java) V2.11.002
=======================================

Thank you for installing Krakatau Professional for Java.

Once setup has completed a new Program Group "Krakatau Professional (Java)" will 
have been created.

To start Krakatau Professional run:

Start - All Programs - Krakatau Professional (Java) - Krakatau Professional (Java)
...
From V2.11.001
 * CBO metric corrected
 * SEIMI metric corrected
 * User Guide included

Licenses
========

Krakatau Professional requires a license to run. A 7-day evalutaion license 
can be obtained contacting Power Software.
