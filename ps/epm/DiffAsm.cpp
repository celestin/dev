...
DiffAsm::DiffAsm(const char *filename1, const char *filename2) : Diff(filename1, filename2, false)
{
  theNSCValid = false;
}


void DiffAsm::getLineCR(FILE *input, char *&currline)
{
...
void DiffAsm::getLineSC(FILE *input, char *&currline) {}
