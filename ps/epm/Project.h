 ...
 * CAM  24-Feb-2010  10579 : Add metric.mtype.
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
bool createDatabase(string serverName, string userName, string password,
  ...
  projDb.executeResultlessQuery("CREATE TABLE IF NOT exists metric (mid int not null, m_type char(1) not null, m_name varchar(10) not null, m_desc varchar(255) NOT NULL, primary key (mid))");
  projDb.executeResultlessQuery("INSERT INTO metric VALUES (100,'G','LOC','Lines of Code'),(101,'G','SLOC','Source Lines of Code'),(106,'G','PLOC','Number of Preprocessor Directive Lines of Code (often beginning with #)'),(107,'G','LLOC','Number of Logical Lines of Code (terminated by semi-colons)'),(108,'G','N1','Total No. of Operators'),(109,'G','N2','Total No. of Operands'),(110,'G','n1','No. of unique or distinct Operators'),(111,'G','n2','No. of unique or distinct Operands'),(112,'G','N','Halstead program Length (calculated as N1 + N2)'),(113,'G','n','Halstead program Vocabulary (calculated as n1 + n2)'),(114,'G','V','Halstead Volume (calculated as V = Nlog2n)'),(115,'G','D','Halstead program Difficulty'),(116,'G','E','Halstead program Effort (calculated as D * V)'),(117,'G','B','Halstead Bug Prediction'),(118,'G','J_COM','Java-style Comment Lines'),(119,'G','C_COM','C-style Comment Lines'),(120,'G','EOL_COM','To End Of Line Comment Lines'),(121,'G','COM_LOC','Total Comment Lines'),(122,'G','BYTES','File size in bytes'),(123,'G','NFILE','Number of Files')");
  projDb.executeResultlessQuery("INSERT INTO metric VALUES (102,'G','SLOC_NAT','Native Source Lines of Code'),(103,'G','SLOC_TAG','Tag Source Lines of Code'),(104,'G','SLOC_HTM','HTML Source Lines of Code'),(105,'G','SLOC_SCR','Script Source Lines of Code')");
  projDb.executeResultlessQuery("INSERT INTO metric VALUES (124,'C','CHG_SLOC','Changed Source Lines of Code'),(125,'C','DEL_SLOC','Deleted Source Lines of Code'),(126,'C','ADD_SLOC','Added Source Lines of Code'),(127,'C','CRN_SLOC','Churn Source Lines of Code'),(128,'C','CHG_LLOC','Changed Logical Lines of Code'),(129,'C','DEL_LLOC','Deleted Logical Lines of Code'),(130,'C','ADD_LLOC','Added Logical Lines of Code'),(131,'C','CRN_LLOC','Churn Logical Lines of Code'),(132,'C','CHG_FILE','Changed Files'),(133,'C','DEL_FILE','Deleted Files'),(134,'C','ADD_FILE','Added Files'),(135,'C','CRN_FILE','Churn Files')");
