...
bool createDatabase(string serverName, string userName, string password,
  ...
  projDb.executeResultlessQuery("INSERT INTO metric VALUES (100,'LOC','Lines of Code'),(101,'SLOC','Source Lines of Code'),(102,'NSC','Number of Semi-colon lines (Logical LOC)'),(103,'N1','Total No. of Operators'),(104,'N2','Total No. of Operands'),(105,'n1','No. of unique or distinct Operators'),(106,'n2','No. of unique or distinct Operands'),(107,'N','Halstead program Length (calculated as N1 + N2)'),(108,'n','Halstead program Vocabulary (calculated as n1 + n2)'),(109,'V','Halstead Volume (calculated as V = Nlog2n)'),(110,'D','Halstead program Difficulty'),(111,'E','Halstead program Effort (calculated as D * V)'),(112,'B','Halstead Bug Prediction'),(113,'J_COM','Java-style Comment Lines'),(114,'C_COM','C-style Comment Lines'),(115,'EOL_COM','To End Of Line Comment Lines'),(116,'COM_LOC','Total Comment Lines'),(117,'BYTES','File size in bytes'),(118,'NFILE','Number of Files'),(119,'CHG_SLOC','Changed Source Lines of Code'),(120,'DEL_SLOC','Deleted Source Lines of Code'),(121,'ADD_SLOC','Added Source Lines of Code'),(122,'CHG_FILE','Changed Files'),(123,'DEL_FILE','Deleted Files'),(124,'ADD_FILE','Added Files')");
