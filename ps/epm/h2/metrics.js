...
metd["F"]["107"]["C"] = "N1";
metd["F"]["107"]["N"] = "Halstead total number of operators";
metd["F"]["107"]["H"] = "The total number of operators in the file.<br><br>N1 is part of the Halstead set, and of little interest on its own.  When combined with the other Halstead fundamental metrics, it can be used to determine Volume, Difficult, Effort and Cyclomatic complexity.";

metd["F"]["108"] = new Array();
metd["F"]["108"]["C"] = "N2";
metd["F"]["108"]["N"] = "Halstead total number of operands";
metd["F"]["108"]["H"] = "The total number of operands in the file.<br><br>N2 is part of the Halstead set, and of little interest on its own.  When combined with the other Halstead fundamental metrics, it can be used to determine Volume, Difficult, Effort and Cyclomatic complexity.";

metd["F"]["109"] = new Array();
metd["F"]["109"]["C"] = "n1";
metd["F"]["109"]["N"] = "Halstead number of unique operators";
metd["F"]["109"]["H"] = "The number of unique or distinct operators in the file.<br><br>n1 is part of the Halstead set, and of little interest on its own.  When combined with the other Halstead fundamental metrics, it can be used to determine Volume, Difficult, Effort and Cyclomatic complexity.";

metd["F"]["110"] = new Array();
metd["F"]["110"]["C"] = "n2";
metd["F"]["110"]["N"] = "Halstead number of unique operands";
metd["F"]["110"]["H"] = "The number of unique or distinct operands in the file.<br><br>n2 is part of the Halstead set, and of little interest on its own.  When combined with the other Halstead fundamental metrics, it can be used to determine Volume, Difficult, Effort and Cyclomatic complexity.";

metd["F"]["111"] = new Array();
metd["F"]["111"]["C"] = "N";
metd["F"]["111"]["N"] = "Halstead program Length";
metd["F"]["111"]["H"] = "Halstead program Length (N) for this file is calculated as N1 + N2.<br><br>N1 = Total number of Operators<br>N2 = Total number of Operands";
metd["F"]["111"]["F"] = "N = N1 + N2";

metd["F"]["112"] = new Array();
metd["F"]["112"]["C"] = "n";
metd["F"]["112"]["N"] = "Halstead program Vocabulary";
metd["F"]["112"]["H"] = "Halstead program Vocabulary (n) for this file is calculated as n1 + n2.<br><br>n1 = Number unique or distinct Operators<br>n2 = Number unique or distinct Operands";
metd["F"]["112"]["F"] = "n = n1 + n2";

metd["F"]["113"] = new Array();
metd["F"]["113"]["C"] = "V";
metd["F"]["113"]["N"] = "Halstead program Volume";
metd["F"]["113"]["H"] = "Halstead Volume for the file.  Calculated as:";
metd["F"]["113"]["F"] = "V = Nlog<SUB>2</SUB>n";

metd["F"]["114"] = new Array();
metd["F"]["114"]["C"] = "D";
metd["F"]["114"]["N"] = "Halstead program Difficulty";
metd["F"]["114"]["H"] = "A measure of how difficult this file's code is to understand.";
metd["F"]["114"]["F"] = "D = (n1/2) * (N2/n2) <br><br>Where:<br>n1 - the number of distinct operators<br>n2 - the number of distinct operands<br>N1 - the total number of operators <br>N2 - the total number of operands";

metd["F"]["115"] = new Array();
metd["F"]["115"]["C"] = "E";
metd["F"]["115"]["N"] = "Halstead program Effort";
metd["F"]["115"]["H"] = "Effort = Difficulty * Volume for this file.";
metd["F"]["115"]["F"] = "E = D * V";
...
metd["P"]["107"]["C"] = "N1";
metd["P"]["107"]["N"] = "Halstead total number of operators";
metd["P"]["107"]["H"] = "The total number of operators in the project.<br><br>N1 is part of the Halstead set, and of little interest on its own.  When combined with the other Halstead fundamental metrics, it can be used to determine Volume, Difficult, Effort and Cyclomatic complexity.";

metd["P"]["108"] = new Array();
metd["P"]["108"]["C"] = "N2";
metd["P"]["108"]["N"] = "Halstead total number of operands";
metd["P"]["108"]["H"] = "The total number of operands in the project.<br><br>N2 is part of the Halstead set, and of little interest on its own.  When combined with the other Halstead fundamental metrics, it can be used to determine Volume, Difficult, Effort and Cyclomatic complexity.";

metd["P"]["109"] = new Array();
metd["P"]["109"]["C"] = "n1";
metd["P"]["109"]["N"] = "Halstead number of unique operators";
metd["P"]["109"]["H"] = "The number of unique or distinct operators in the project.<br><br>n1 is part of the Halstead set, and of little interest on its own.  When combined with the other Halstead fundamental metrics, it can be used to determine Volume, Difficult, Effort and Cyclomatic complexity.";

metd["P"]["110"] = new Array();
metd["P"]["110"]["C"] = "n2";
metd["P"]["110"]["N"] = "Halstead number of unique operands";
metd["P"]["110"]["H"] = "The number of unique or distinct operands in the project.<br><br>n2 is part of the Halstead set, and of little interest on its own.  When combined with the other Halstead fundamental metrics, it can be used to determine Volume, Difficult, Effort and Cyclomatic complexity.";

metd["P"]["111"] = new Array();
metd["P"]["111"]["C"] = "N";
metd["P"]["111"]["N"] = "Halstead program Length";
metd["P"]["111"]["H"] = "Halstead program Length (N) for this project.<br><br>N1 = Total number of Operators<br>N2 = Total number of Operands";
metd["P"]["111"]["F"] = "N = N1 + N2";

metd["P"]["112"] = new Array();
metd["P"]["112"]["C"] = "n";
metd["P"]["112"]["N"] = "Halstead program Vocabulary";
metd["P"]["112"]["H"] = "Halstead program Vocabulary (n) for this project.<br><br>n1 = Number unique or distinct Operators<br>n2 = Number unique or distinct Operands";
metd["P"]["112"]["F"] = "n = n1 + n2";

metd["P"]["113"] = new Array();
metd["P"]["113"]["C"] = "V";
metd["P"]["113"]["N"] = "Halstead program Volume";
metd["P"]["113"]["H"] = "Halstead Volume for the project.";
metd["P"]["113"]["F"] = "V = Nlog<SUB>2</SUB>n";

metd["P"]["114"] = new Array();
metd["P"]["114"]["C"] = "D";
metd["P"]["114"]["N"] = "Halstead program Difficulty";
metd["P"]["114"]["H"] = "A measure of how difficult this project's code is to understand.";
metd["P"]["114"]["F"] = "D = (n1/2) * (N2/n2) <br><br>Where:<br>n1 - the number of distinct operators<br>n2 - the number of distinct operands<br>N1 - the total number of operators <br>N2 - the total number of operands";

metd["P"]["115"] = new Array();
metd["P"]["115"]["C"] = "E";
metd["P"]["115"]["N"] = "Halstead program Effort";
metd["P"]["115"]["H"] = "Effort = Difficulty * Volume for this project.";
metd["P"]["115"]["F"] = "E = D * V";
...
metd["P"]["117"]["C"] = "J_COM";
metd["P"]["117"]["N"] = "Java style comments";
metd["P"]["117"]["H"] = "The number of Java style comments  in the project.<br><br>A Java style comment begins <font face=\"Courier New\" color=\"FF1111\">/**</font> and ends <font face=\"Courier New\" color=\"FF1111\">*/</font>. E.g.:<br><br><font face=\"Courier New\"><font color=\"FF1111\">&nbsp;/**<br>&nbsp;&nbsp;* An interface for handling Application level operations.<br>&nbsp;&nbsp;*<br>&nbsp;&nbsp;*/</font><br>&nbsp;public interface ApplicationHandler {</font><br><br>J_COM = 1.";

metd["P"]["118"] = new Array();
metd["P"]["118"]["C"] = "C_COM";
metd["P"]["118"]["N"] = "C style comments";
metd["P"]["118"]["H"] = "The number of C style comments in the project.<br><br>A C style comment begins <font face=\"Courier New\" color=\"FF1111\">/*</font> and ends <font face=\"Courier New\" color=\"FF1111\">*/</font>.<br><br>In the following example C_COM = 1.<br><br><font face=\"Courier New\">int i = 0 ; <font color=\"FF1111\">/* This is a useful<br>variable here for<br>many purposes */</font></font>";

metd["P"]["119"] = new Array();
metd["P"]["119"]["C"] = "EOL_COM";
metd["P"]["119"]["N"] = "To End-of-Line comments";
metd["P"]["119"]["H"] = "The number of to end-of-line comment lines in the project.<br><br>This type of comment begins <font face=\"Courier New\" color=\"FF1111\">//</font> and finishes at the end of the line.<br><br>In the following example EOL_COM=2.<br><br><font face=\"Courier New\">int i = 0 ; <font color=\"FF1111\">// Index variable</font><br>float pi = 3.14 ; <font color=\"FF1111\">// Handy pi variable</font><br>char star = '*' ;</font>";

metd["P"]["120"] = new Array();
metd["P"]["120"]["C"] = "COM_LOC";
...
metd["P"]["122"]["H"] = "The total number of files in the project.";

metd["P"]["123"] = new Array();
metd["P"]["123"]["C"] = "CHG_SLOC";
metd["P"]["123"]["N"] = "Source Lines of Code (Changed)";
metd["P"]["123"]["H"] = "The number of lines that have changed between the old project and the new  project.";
metd["P"]["123"]["F"] = "&#0931; changed file CHG_SLOC";

metd["P"]["124"] = new Array();
metd["P"]["124"]["C"] = "DEL_SLOC";
metd["P"]["124"]["N"] = "Source Lines of Code (Deleted)";
metd["P"]["124"]["H"] = "This gives the total deleted source lines of code between the old and the new project.<br><br>This is the sum of DEL_SLOC for all changed files plus the SLOC of all files deleted from the new project";
metd["P"]["124"]["F"] = "(&#0931; changed file DEL_SLOC ) + (&#0931; SLOC deleted files)";

metd["P"]["125"] = new Array();
metd["P"]["125"]["C"] = "ADD_SLOC";
metd["P"]["125"]["N"] = "Source Lines of Code (Added)";
metd["P"]["125"]["H"] = "This gives the total added source lines of code between the old and the new project.<br><br>This is the sum of ADD_SLOC for all changed files plus the SLOC of all files added to the new project";
