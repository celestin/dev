...
#define AUTONUMBER 0
  ...
  public:
    ...
    {
      strcpy_s(sql, QUERY_MAX, "Insert into link values ") ;
    }
    ...
    void getValues(char *sql)
    {
      ...
      strcat_s(sql, QUERY_MAX, ltostr(theSourceID, charNumber, 30)) ;
      strcat_s(sql, QUERY_MAX,",") ;

      strcat_s(sql, QUERY_MAX, ltostr(theDestID, charNumber, 30)) ;
      strcat_s(sql, QUERY_MAX,",") ;
