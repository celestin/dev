...
$scriptFile = '/u/p/o/w/powersft/docs/script/detailsem.js' ;
...
$actpage.="<img src=\"http://www.powersoftware.com/img/title/buyem.gif\" border=0>\n" ;

$actpage.="<FORM name=\"details\" action=\"/cgi-bin/www.power-soft.co.uk/buyem.pl\" method=post>" ;
