 ...
 *
 * $Log: /web/cc/frm/quiz.add.answer.multi.php $
 * 
...
<tr><td align=center colspan=2><input class="button" type=submit value="Go to Answer screen" size=35><input type=hidden name="action" value="ans"></td></tr>
