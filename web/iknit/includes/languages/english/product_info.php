 ...
 *
 * Who  When         Why
 * CAM  12-Jun-2010  10709 : Added TEXT_ASSOCIATED_PRODUCTS.
 * * * * * * * * * * * * * * * * * * * * * * * */

define('TEXT_PRODUCT_NOT_FOUND', 'Product not found!');
define('TEXT_CURRENT_REVIEWS', 'Current Reviews:');
define('TEXT_MORE_INFORMATION', 'For more information, please visit this product&rsquo;s <a href="%s" target="_blank"><u>webpage</u></a>.');
...
define('TEXT_ASSOCIATED_PRODUCTS', 'Associated products');
?>
