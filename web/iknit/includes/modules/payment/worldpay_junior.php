 ...
 * CAM  15-Jul-2010  10746 : Added label for Comments.
 * CAM  20-Jul-2010  10760 : Switch to Production environment.
 * * * * * * * * * * * * * * * * * * * * * * * */
...
// lets start with the email confirmation
      ...
      if ($order->info['comments']) {
        ...
        $email_order .= EMAIL_TEXT_COMMENTS . "\n" .
                        EMAIL_SEPARATOR . "\n" .
                        tep_db_output($order->info['comments']) . "\n" .
                        EMAIL_SEPARATOR . "\n\n";

      //} else {
      //  $email_order .= "** NO COMMENTS **\n\n";
      }
      ...
      $subject = EMAIL_TEXT_SUBJECT . " " . $order_id;

      tep_mail($order->customer['firstname'] . ' ' . $order->customer['lastname'], $order->customer['email_address'], $subject, $email_order, STORE_NAME, STORE_OWNER_EMAIL_ADDRESS);
      tep_mail(STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS, "Copy of " . $subject, $email_order, STORE_NAME, STORE_OWNER_EMAIL_ADDRESS);
