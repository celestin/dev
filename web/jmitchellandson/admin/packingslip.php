 ...
 * CAM  28-Dec-2010  10909 : Added Order Date as Packing Slip Date under logo.
 * * * * * * * * * * * * * * * * * * * * * * * */
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="pageHeading" align="right"><?php echo tep_image(DIR_WS_CATALOG_IMAGES . 'jmitchellandson2.png', STORE_NAME); ?><br />
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td colspan="2" align="center" class="documentTitle"><?php echo DOCUMENT_TITLE . " " . $oID; ?></td>
      </tr>
      <tr>
