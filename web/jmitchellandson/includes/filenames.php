...
// define the filenames used in the project
  ...
  define('FILENAME_JEWELLERY_CARE', 'jewellery_care.php');
  define('FILENAME_BIRTHSTONES', 'birthstones.php');

  define('FILENAME_SECUREPAYMENT', 'securepayment.php');

  define('FILENAME_ANALYTICS', 'googleanalytics.php');
