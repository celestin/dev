...
<?php require(DIR_WS_INCLUDES . 'table_header_top.php'); ?>
  <tr class="header">
    <td width="100%" valign="middle"><?php echo '<a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . tep_image(DIR_WS_IMAGES . 'jmitchellandson2.png', STORE_NAME) . '</a>'; ?></td>
    <?php
    ...
    ?>
    <td align="right" valign="middle"><a href="<?php echo tep_href_link(FILENAME_SECUREPAYMENT);?>"><?php echo tep_image(DIR_WS_IMAGES . 'payment/worldpay.png', HEADER_TITLE_WORLDPAY); ?></a></td>
    <td align="right" valign="middle"><a href="<?php echo tep_href_link(FILENAME_SECUREPAYMENT);?>"><?php echo tep_image(DIR_WS_IMAGES . 'payment/cards_small.png', HEADER_TITLE_WORLDPAY); ?></a></td>
  </tr>
</table>
<?php require(DIR_WS_INCLUDES . 'table_header_top.php'); ?>
