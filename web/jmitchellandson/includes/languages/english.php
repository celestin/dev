 ...
 * CAM  29-May-2010  10670 : Removed brackets from pagination buttons.
...
define('HEADER_TITLE_CARDS', 'We accept Mastercard, JCB, Maestro, Solo and Visa');
define('HEADER_TITLE_WORLDPAY', 'Our secure payments are handled by RBS Worldpay');
...
define('BOX_INFORMATION_SHIPPING', 'Postage & Returns');
define('BOX_INFORMATION_CONTACT', 'Contact Us');
define('BOX_INFORMATION_ABOUTUS', 'About Us');
define('BOX_INFORMATION_BIRTHSTONES', 'Birthstones');
define('BOX_INFORMATION_JEWELLERY_CARE', 'Jewellery Care');
define('BOX_INFORMATION_SECUREPAYMENT', 'Secure Payment');
...
define('TEXT_GREETING_PERSONAL', 'Welcome back, %s!  Would you like to see which <a href="%s">new products</a> are available to purchase?');
...
define('TEXT_GREETING_GUEST', 'Welcome! Would you like to <a href="%s">log yourself in</a>? Or would you prefer to <a href="%s">create an account</a>?');
...
define('TEXT_AVERAGE_REVIEW', 'Average Rating: %s');
