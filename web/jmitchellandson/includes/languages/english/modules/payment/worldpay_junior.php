 ...
 *
 * Who  When         Why
 * CAM  15-Jul-2010  10746 : Updated title to RBS WorldPay.
 * CAM  20-Jul-2010  10759 : Added MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_UNSUCCESSFUL_TRANSACTION.
 * * * * * * * * * * * * * * * * * * * * * * * */

  define('MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_TITLE', 'RBS WorldPay');
  ...
  define('MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_UNSUCCESSFUL_TRANSACTION', 'The payment transaction has NOT been successfully completed!');
  define('MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_CONTINUE_BUTTON', 'Continue to %s');
?>
