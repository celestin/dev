...
// page title
define('TITLE', 'J.Mitchell &amp Son Jewellers Administration');
...
define('BOX_TAXES_GEO_ZONES', 'VAT Zones');
define('BOX_TAXES_TAX_CLASSES', 'VAT Classes');
define('BOX_TAXES_TAX_RATES', 'VAT Rates');
