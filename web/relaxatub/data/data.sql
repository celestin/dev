...
--
-- Host: localhost
-- Generation Time: Oct 06, 2006 at 09:54 PM
...
INSERT INTO acc (acc, accName, dispOrder, photo) VALUES
(94889, 'Lift''n''Store', 100, '94889.jpg'),
...
INSERT INTO photo (photo, location, tub) VALUES
('p001.jpg', 'Aberdeen', NULL),
...
('p025.jpg', 'Stonehaven', NULL),
('p026.jpg', 'Bucksburn', NULL),
('p027.jpg', 'Bucksburn', NULL),
('p028.jpg', 'Bucksburn', NULL);
...
INSERT INTO series (series, seriesName) VALUES
(300, '300 Series'),
(500, '500 Series'),
(700, '700 Series');
...
(500, '550x', 0, 'Shown in Azure', 'glacier.jpg', 'twilight_enviroskirt.jpg', 'Large', '8-9', '203 x 224 x 91 cm', '1363 Litres', '295 kg', '1658 kg', '20 locations selected to enable you to choose the type of therapy for your personalised body massage', 'Customise this 550x from a minimum of 24-90 different types of jetting combinations at no cost', 'High performing, efficient water cleaning system', 'Easy programming for heating and filtering to save money', 'Tight thermos bottle seal to save energy and money', 'Powerful 3.5 hp pump with stainless steel heater', 'Built to the highest standards available', 'Mood setting and safety for entry and exit', 'A no-fine-print, straightforward customer guarantee', NULL, NULL, NULL, NULL),
