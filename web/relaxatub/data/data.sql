...
--
-- Host: localhost
-- Generation Time: Jul 18, 2006 at 12:50 PM
...
CREATE TABLE acc (
  ...
  PRIMARY KEY  (acc)
) TYPE=MyISAM COMMENT='Accessories';
...
CREATE TABLE photo (
  ...
  PRIMARY KEY  (photo)
) TYPE=MyISAM COMMENT='Photo Album';
