...
$hymn_search_id = intval(mosGetParam($_REQUEST ,'hymn_search_id', 0));
$catid = intval(mosGetParam($_REQUEST ,'catid', 0));

switch ($task) {
  default:
    hymn_searchpage($option, $hymn_search_id);
    break;
}
...
function hymn_searchpage($option, $hymn_search_id) {
...
function output_hymn_lines($hymn_lines) {
?>
