...
/** components/com_hymn_search */
DEFINE('_HYMNSEARCH_TITLE', 'Hymn Search');
...
/** components/com_min_search */
DEFINE('_MINSEARCH_TITLE',   'Christian Ministry Search');
DEFINE('_MINSEARCH_TEXT',    'Search for:');
DEFINE('_MINSEARCH_AUTHOR',  'Servant:');
DEFINE('_MINSEARCH_GO',      'Search Ministry');

/** components/com_hitchcock */
DEFINE('_HITCHCOCK_TITLE',   'Hitchcock Proper Names');
DEFINE('_HITCHCOCK_NAME',    'Name');
