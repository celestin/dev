          ...
          <table width="100%"  border="0" cellpadding="5">
              ...
              <td width="43%"><div align="center"><img src="../images/altonlogo.jpg" width="298" height="65"></div></td>
                <td width="57%" rowspan="2" valign="top"><p style="margin-top: 0; margin-bottom: 0">Alton
                  ...
                  <p style="margin-top: 0; margin-bottom: 0;">Unique Low-level
                    Ventilation. Concrete Base Kerbs.</p></td>
            </tr>
            <tr>
            ...
            <table width="100%"  border="1" cellspacing="0" cellpadding="2">
              <tr align="center" bgcolor="#339933">
                <td width="24%">&nbsp;</td>
                <td width="22%" class="table"><strong>Model</strong></td>
                <td width="7%"><strong>Width</strong></td>
                <td width="6%"><strong>Length</strong></td>
                <td width="7%"><strong>Eave Height </strong></td>
                <td width="8%"><strong>No. of Vents </strong></td>
                <td width="26%"><strong>Doors/Options</strong></td>
              </tr>
              <tr>
                ...
                <td><p style="margin-top: 0; margin-bottom: 0">8'</p>
                  ...
                  <p style="margin-top: 0; margin-bottom: 0;">20'7&quot;</p></td>
                <td>5'5&quot;</td>
              ...
              <tr>
                ...
                <td>Traditional</td>
                <td><p style="margin-top: 0; margin-bottom: 0">6'3&quot;</p>
                </td>
                <td><p style="margin-top: 0; margin-bottom: 0">5'6&quot;</p>
              ...
              <tr>
                ...
                <td>Octagonal</td>
                <td><p style="margin-top: 0; margin-bottom: 0">6'</p>
                ...
                <td><p style="margin-top: 0; margin-bottom: 0">6'</p>
                  <p style="margin-top: 0; margin-bottom: 0;">8'</p>
                  <p style="margin-top: 0; margin-bottom: 0;">8'</p>
                  <p style="margin-top: 0;">10'</p>
                </td>
                <td><p style="margin-top: 0; margin-bottom: 0">5'5&quot;</p>
                  <p style="margin-top: 0; margin-bottom: 0;">6'2&quot;</p></td>
                <td><p style="margin-top: 0; margin-bottom: 0">1</p>
                  <p style="margin-top: 0; margin-bottom: 0;">2</p>
                  <p style="margin-top: 0; margin-bottom: 0;">2</p>
                  <p style="margin-top: 0; margin-bottom: 0;">2</p></td>
                <td><p style="margin-top: 0; margin-bottom: 0"><br>
                    Single Door 2'2&quot; wide.</p>
