...
<table width="100%"  border="0" cellpadding="5">
  <tr>
    <td width="43%"><img name="logo" src="../images/rob_logo.jpg" width="300" height="60" alt=""></td>
      <td width="57%" rowspan="2" valign="top">Robinsons produce one
        of the strongest Domestic and Semi-commercial Greenhouses. Their
        design, strength and <strong>first class glazing system</strong>
        all contribute to make them able to withstand storms and wind
        which can soon demolish other makes. Standard models are listed
        below, but we specialise in custom-made models as well. Let
        us know your requirements and we will probably be able to supply
        a greenhouse to suit. <strong>Partitions</strong> and <strong>Extensions</strong>
        are available.  All Greenhouses can be extended accept Riviera.</td>
  </tr>
  <tr>
  ...
  <table width="100%"  border="1" cellspacing="0" cellpadding="2">
    <tr align="center" bgcolor="#339933">
      <td width="25%">&nbsp;</td>
      <td width="17%" class="table"><strong>Model</strong></td>
      <td width="8%"><strong>Width</strong></td>
      <td width="8%"><strong>Length</strong></td>
      <td width="14%"><strong>Eave Height </strong></td>
      <td width="14%"><strong>No. of Vents </strong></td>
      <td width="14%"><strong>Doors</strong></td>
    </tr>
